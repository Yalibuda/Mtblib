...
namespace Mtblib.Graph.Component.Region
{
    ...
    public class DataRegion : Region
    {
        ...
        /// <summary>
        /// 設定 Data region 的位置 (4個座標值，依序為 xmin, xmax, ymin ymax)
        /// </summary>
        /// <param name="args"></param>
        public override void SetCoordinate(params object[] args)
        {
            if (args.Length != 4) throw new ArgumentException("Data 有不正確的參數個數，必須為 4 個!");
